...
debootstrap --foreign --arch $RepoArch --variant=minbase --include=busybox-static,dbus,dropbear,firewalld,ntpdate,openssh-client,openssh-sftp-server,sudo,systemd,rsync,tmux,xfsprogs --exclude=cpio,fdisk,gzip,hostname,ifupdown,iputils-ping,less,libfdisk1,procps,vim-common,vim-tiny,whiptail,zlib1g bookworm $WorkDir http://ftp.uk.debian.org/debian
